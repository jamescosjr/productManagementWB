...
describe("ProductManagementRepository", () => {
  ...
  it("should return false when the product with the given id does not exist", () => {
    expect(findProductById("123")).toBeUndefined();
  });
  ...
  it("should return the products with the given stock", () => {
    ...
    expect(listByStock(10)).toEqual(expectedProducts);
  });

  it("should return true when the product with the given id is deleted", () => {
    const product = {
      name: "Product 1",
      category: "Category 1",
      price: 100,
  ...
  it("should return false when the product with the given id does not exist", () => {
    expect(deleteProduct("123")).toBeFalsy();
  });

  it("should return true when the product with the given id is updated", () => {
    const product = {
      name: "Product 1",
      category: "Category 1",
      price: 100,
    ...
    it("should return false when the product with the given id does not exist", () => {
        expect(updateProduct("123", {})).toBeFalsy();
    });
});
