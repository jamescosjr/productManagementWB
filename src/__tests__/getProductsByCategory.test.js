...
describe("GET /products/category/:category", () => {
    describe("success cases", () => {
        it("should return 200 when getting a product by category", async () => {
            ...
            const response = await supertest(app).get(`/products/category/Category 1`);
        ...
        it("should return 200 and an empty array when there is no product with the category", async () => {
            const response = await supertest(app).get(`/products/category/Category 1`);
    ...
    describe("non success cases", () => {
        it("should return 500 when database error", async () => {
            ...
            const response = await supertest(app).get(`/products/category/category`);
